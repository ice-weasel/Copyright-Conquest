        ...
        <div className="min-h-screen  bg-cover">
            ...
            >
                <div className="text-center mt-20">
                    <span className="text-black font-bold uppercase text-2xl italic ">Select a game mode</span>
                </div>
                <div className="mt-20 flex flex-col space-y-10 flex items-center justify-center sm:flex-row justify-around ">
                    <div>
                        <a href="/Selectpage">
                            <div className=" max-w-sm bg-blue-200 bg-opacity-50 border border-gray-200 rounded-lg shadow  transition duration-500 hover:scale-125  ">
                                <a href="#">
                                    <img
                                ...
                                <div className="p-5">
                                    <a href="#">
                                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Quiz</h5>
                                    </a>
                    ...
                    <div>
                        <a href="/Quizpage">
                            <div className="max-w-sm bg-blue-200 bg-opacity-50 border border-gray-200 rounded-lg shadow  transition duration-500 hover:scale-125 ">
                                ...
                                <div className="p-5">
                                    <a href="#">
                                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Select Option</h5>
                                    </a>
                                    <p className="mb-3 font-normal text-gray-700 ">
                                        Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.
                                    </p>
